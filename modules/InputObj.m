classdef InputObj
    ...
    methods
        function obj = InputObj(InputFile,temperature_source,...
            ...
            [obj.SpeciesParams, obj.SpeciesNames] = xlsread(InputFile,'Parameters','B29:AE56'); %Species 
            obj.SpeciesNames = obj.SpeciesNames(:,~all(cellfun('isempty',obj.SpeciesNames))); %Remove empty text columns
            obj.FeedPreferences = xlsread(InputFile,'FeedPreferences','B3:AA30'); %Feeding Preferences
            obj.FeedMins = xlsread(InputFile,'FeedPreferencesMin','B3:AA30'); % Feeding minima for stochastic
            obj.FeedMaxs = xlsread(InputFile,'FeedPreferencesMax','B3:AA30'); % Feeding maxima room for stochastic
        ...
        function MeHgWaterConc = get_MeHg(obj,t)
            if strcmpi(obj.isMeHgseries,'No')
                MeHgWaterConc = obj.WaterParams(1); % Concentration of MeHg in water
            else
